<template>
  <div>
    <table class="striped">
      ...
      <tbody>
        <tr v-for="kubeObject of kubernetesObjectStore.data.jobs" v-bind:key="kubeObject.metadata.uid">
    ...
    async showDetails(namespace, objectName) {
      ...
      await axios
        .post(
          ...
          { namespace, object: "job", command: "describe", argument: objectName, noJson: true },
