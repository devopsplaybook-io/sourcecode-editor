    ...
    getRoutes(fastify) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            fastify.get("/", (req, res) => __awaiter(this, void 0, void 0, function* () {
                ...
                const sourceLabels = yield (0, SourceLabelsData_1.SourceLabelsDataListForUser)((0, StandardTracer_1.StandardTracerGetSpanFromRequest)(req), userSession.userId);
            ...
            fastify.get("/counts/unread", (req, res) => __awaiter(this, void 0, void 0, function* () {
                ...
                const counts = yield (0, SourcesData_1.SourcesDataListCountsForUser)((0, StandardTracer_1.StandardTracerGetSpanFromRequest)(req), userSession.userId);
                return res.status(201).send({ counts });
            }));
            fastify.get("/counts/saved", (req, res) => __awaiter(this, void 0, void 0, function* () {
                const userSession = yield (0, Auth_1.AuthGetUserSession)(req);
                if (!userSession.isAuthenticated) {
                    return res.status(403).send({ error: "Access Denied" });
                }
                const counts = yield (0, SourcesData_1.SourcesDataListCountsSavedForUser)((0, StandardTracer_1.StandardTracerGetSpanFromRequest)(req), userSession.userId);
                return res.status(201).send({ counts });
            }));
        });
    }
