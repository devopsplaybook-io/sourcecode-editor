...
test("Password should be successfully verified if it's the same", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, UserPassword_1.UserPasswordSetPassword)(null, user, password);
    expect(yield (0, UserPassword_1.UserPasswordCheckPassword)(null, user, password)).toBeTruthy();
}));
test("Password should be faile to be verified if it's not the same", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = new User_1.User();
    yield (0, UserPassword_1.UserPasswordSetPassword)(null, user, password);
    expect(yield (0, UserPassword_1.UserPasswordCheckPassword)(null, user, passwordWrong)).toBeFalsy();
}));
